...
void h22Event::WriteEvent(){
  fChain->Fill(); 
}

void h22Event::SetCCInformation(clasCCPB_t *CCPB, int index){
...
void h22Event::SetDCInformation(clasDCPB_t *DCPB, int index){
...
void h22Event::SetECInformation(clasECPB_t *ECPB, int index){
...
void h22Event::SetSCInformation(clasSCPB_t *SCPB, int index){
...
void h22Event::SetHEADInformation(clasHEAD_t *HEAD){
  
}

void h22Event::SetHEVTInformation(clasHEVT_t *HEVT){
  
}

void h22Event::SetEVNTInformation(clasEVNT_t *EVNT, int index){
...
void h22Event::SetPARTInformation(clasPART_t *PART){
...
void h22Event::SetScalarInformation(clasTRGS_t *TRGS){
